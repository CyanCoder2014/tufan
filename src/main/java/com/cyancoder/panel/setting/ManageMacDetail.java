...
import com.cyancoder.service.AddFromExcel;
...
public class ManageMacDetail extends javax.swing.JFrame {
    ...
    Statement st;
    Integer macTypeId;
    ArrayList<MachineDetail> machines = new ArrayList<>();

    public ManageMacDetail(Integer macTypeId) {
...
//        jLabel3.setText("Reg Number");
        ...
        txtDistance.setFont(new java.awt.Font("Tahoma", 0, 12));
        ...
        btnShowDetail.setText("ورود داده‌ها از قابل اکسل");
...
//            new ManageMacDetail().setVisible(true);
//        });
    }
